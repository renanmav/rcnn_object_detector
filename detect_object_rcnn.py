...
from rcnn_object_detection.nms import non_max_supression
...
# run selective serach on the image to generate bounding box proposal
# regions
...
# initialize the list of regions proposals that we'll be classifying
# along with their associated bounding boxes
proposals = []
boxes = []

# loop over the region proposal bounding bx coordinates generated by
...
# classify each of the proposal ROIs using fine-tunned model
...
# write image without NMS
cv2.imwrite("before_nms.png", clone)

# run non-maxima supression on the bounding boxes
...
# write image with NMS
cv2.imwrite("after_nms.png", clone)
